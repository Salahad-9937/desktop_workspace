...
/// Базовая темная палитра оформления многооконного рабочего пространства.
...
/// Псевдоним обратной совместимости для [DesktopTheme].
typedef WorkspaceTheme = DesktopTheme;