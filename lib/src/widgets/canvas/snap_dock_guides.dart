...
/// Виджет визуализации краевых зон магнитного прилипания к экрану (половины, четверти, развертывание).
    ...
    return IgnorePointer(
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          return Stack(
            children: <Widget>[
              // Верхний край (развертывание на весь экран)
              _buildDockZone(
