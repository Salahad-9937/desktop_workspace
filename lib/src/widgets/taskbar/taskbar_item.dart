...
/// Кнопка окна на панели задач с индикацией состояния и всплывающей карточкой предпросмотра.
class TaskbarItem extends ConsumerStatefulWidget {
  /// Состояние связанного окна.
  final WindowState win;

  /// Создает экземпляр [TaskbarItem].
  const TaskbarItem({
    super.key,
    required this.win,
  });
  ...
  @override
  ConsumerState<TaskbarItem> createState() => _TaskbarItemState();
}

class _TaskbarItemState extends ConsumerState<TaskbarItem> {
